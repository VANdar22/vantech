...
const StepCard = ({ number, title, description, isActive, onNext, onPrev }) => (
  <div className="relative w-full flex flex-col items-center justify-center min-h-[420px] sm:h-[420px] px-4 sm:px-12">
    <button
      onClick={onPrev}
      className="hidden sm:block absolute -left-10 top-1/2 -translate-y-1/2 p-2.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 active:scale-95 transform transition-all duration-200 ease-in-out z-10 shadow-lg hover:shadow-xl w-10 h-10 rounded-full"
    ...
    <motion.div
      ...
      className="w-full max-w-[320px] h-[360px] sm:w-full sm:max-w-3xl sm:h-[340px] p-6 sm:p-8 bg-gray-100 dark:bg-gray-800 relative mx-auto overflow-hidden border border-gray-200 dark:border-gray-700 shadow-[8px_8px_0_0_rgba(0,0,0,0.1)] dark:shadow-[8px_8px_0_0_rgba(255,255,255,0.05)] transform transition-all duration-300 hover:shadow-[12px_12px_0_0_rgba(0,0,0,0.15)] dark:hover:shadow-[12px_12px_0_0_rgba(255,255,255,0.1)] hover:-translate-x-0.5 hover:-translate-y-0.5"
    >
      <div className="absolute inset-0 opacity-2 overflow-hidden">
        {/* Corner borders */}
        <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-[#ea1841]/30 dark:border-[#ff5c5c]/60 opacity-100" />
        <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-[#ea1841]/30 dark:border-[#ff5c5c]/60 opacity-100" />
        <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-[#ea1841]/30 dark:border-[#ff5c5c]/60 opacity-100" />
        <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-[#ea1841]/30 dark:border-[#ff5c5c]/60 opacity-100" />
      ...
      <div className="flex flex-col h-full relative z-10">
        <motion.div 
          ...
          className="text-6xl sm:text-7xl font-bold text-[#ea1821]/80 mb-4 sm:mb-6 font-['Climate_Crisis']"
        >
          {number}
        </motion.div>
        <motion.h3 
          ...
          className="text-xl sm:text-2xl font-bold text-[#ea1821]/80 mb-2 sm:mb-3 font-['Climate_Crisis']"
        >
          {title}
        </motion.h3>
        <motion.p 
          ...
          className="text-gray-700 dark:text-gray-300 text-lg sm:text-xl leading-relaxed mb-6 sm:mb-8 font-['Montserrat']"
        >
          {description}
        </motion.p>
      </div>
    ...
    <button
      onClick={onNext}
      className="hidden sm:block absolute -right-10 top-1/2 -translate-y-1/2 p-2.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 active:scale-95 transform transition-all duration-200 ease-in-out z-10 shadow-lg hover:shadow-xl w-10 h-10 rounded-full"
    ...
    <button
      onClick={onNext}
      className="sm:hidden mt-6 px-6 py-2.5 bg-[#ea1841] dark:bg-[#ff5c5c] text-white rounded-full text-sm font-medium hover:bg-[#d0173a] dark:hover:bg-[#ff4a4a] active:scale-95 transform transition-all duration-200 ease-in-out flex items-center justify-center space-x-2"
      aria-label="Next step"
    >
      <span>Next</span>
    ...
    <div className="flex items-center justify-center mt-6 sm:mt-8 space-x-2">
      <div className="flex space-x-2">
        {[0, 1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className={`w-2.5 h-2.5 rounded-full transition-all ${i === number - 1 ? 'bg-[#ea1841] dark:bg-[#ff5c5c]' : 'bg-gray-300 dark:bg-gray-600'}`}
          />
        ))}
      </div>
    </div>
  ...
  return (
    <section className="py-16 md:py-24 bg-f5f5f5" id="how-we-work">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-[#ea1821] mb-8 font-['Climate_Crisis']">
            Our Process
          </h2>
        </motion.div>
